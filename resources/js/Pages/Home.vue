<template>
    ...
    <div class="mt-64">
        <div class="flex justify-center items-center flex-col px-5 text-white">
            <h1 class="text-4xl md:text-9xl uppercase font-bold text-[#00adb5] text-center">
                Jlad Lanete
            </h1>
            <div class="mt-5">
                <span class="text-3xl md:text-6xl font-normal">{{
                    displayedText
                    }}</span>
        ...
        <div class="w-full mt-32">
            <ul class="flex items-center justify-center flex-wrap md:flex-nowrap gap-5">
                <li v-for="(image, index) in imagePaths" :key="index">
                    <img :src="image" alt="Skills" class="w-10 h-10 mx-2" />
                </li>
                <i class="fa-brands fa-vuejs mt-3 text-left md:mt-0 fa-2xl text-[#00adb5]"></i>
            </ul>
        </div>
    </div>
</template>
