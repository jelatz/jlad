<template>
    ...
    <div class="pt-10">
        <div class="container flex justify-start items-center space-x-5">
...
const heroData = ref({
    img: '',
    alt: 'hero image',
    innerHeroTitle: 'Title for the lifestyle blog',
    innerHeroDescription: 'Description for the lifestyle blog',
