<template>
    <div class="border rounded-md p-3 w-64 min-h-80 flex flex-col items-start justify-center space-y-2">
        <img :src="data.img ? `/storage/${data.img}` : '/images/default.jpg'" :alt="data.alt || 'Blog Image'"
